...
const Contact = () => {
  return (
    <>
    <section id="contact" className="min-h-screen flex flex-col items-center justify-center p-8 bg-primary dark:bg-gray-900 text-gray-800 dark:text-gray-100">
    <h2 className="text-4xl font-bold mb-6 text-center">Get In Touch</h2>
    <p className="text-lg text-center mb-8 max-w-xl text-gray-700 dark:text-gray-300">
